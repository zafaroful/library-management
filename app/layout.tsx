...
import { ThemeController } from "@/app/components/providers/ThemeController";
            ...
            __html: `
              (function () {
                try {
                  ...
                  var isSystem = !savedTheme || savedTheme === 'system';
                  var isDark = savedTheme === 'dark' || (isSystem && window.matchMedia('(prefers-color-scheme: dark)').matches);
